    ...
    <section className="relative flex flex-1 flex-col items-center overflow-x-clip font-[Manrope,sans-serif] text-white">
      ...
      <HeroIntro>
        ...
        <div className="relative z-10 flex w-full flex-col items-center px-6 text-center">
          ...
          >
            Sprout is a debit card and money app built for two people at once —
            a parent who needs visibility, and a kid who needs practice.
          </p>
        ...
        <span
          data-anim="phone"
          className="absolute top-[64.805%] left-1/2 aspect-[0.48374] w-[29.998%] -translate-x-1/2"
        >
          <Image
